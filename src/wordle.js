!function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(require("react"), require("react-dom"), require("react-redux"), require("src/foundation"), require("react-transition-group"), require("reselect"), require("classnames"), require("redux"), require("redux-thunk")) : "function" == typeof define && define.amd ? define(["react", "react-dom", "react-redux", "src/foundation", "react-transition-group", "reselect", "classnames", "redux", "redux-thunk"], t) : t((e = e || self).React, e.ReactDOM, e.ReactRedux, e.Foundation, e.ReactTransitionGroup, e.Reselect, e.classNames, e.Redux, e.ReduxThunk);
  ...
  function m(e) {
    var t = e.children, a = e.regiId, n = (e = u(g.useState({}), 2))[0], o = e[1], r = (e = u(g.useState(!1), 2))[0],
      s = e[1];
    return g.useEffect(function() {
      var e, t, n = (null === (e = window.config) || void 0 === e ? void 0 : e.AbraConfig) || {};
      v.abra.init(window.abra.config, {
        agent_id: (null === (e = window.config) || void 0 === e || null === (t = e.userInfo) || void 0 === t ? void 0 : t.agentID) || v.agentIdCookie,
        regi_id: a
      }, n), o(c({}, v.abra.getTests())), s(!0);
    }, [a]), e = g.useMemo(function() {
      return {
        tests: n, getVariant: function(e) {
          return n[e];
        }, reportExposure: function(e) {
          return v.abra.reportExposure(e);
        }, hasAbraLoaded: r
      };
    }, [n, r]), _.createElement(i.Provider, { value: e }, t);
  }

  var y, f = "nyt-wordle-refresh", h = window.localStorage, b = 432e5;

  function w() {
    return y = y || setInterval(function() {
      h.getItem(f) && (h.removeItem(f), window.isHybridWebView || (document.location.href.match(/.*\.nytimes\.com/g) ? document.location.reload(!0) : document.location.replace("https://www.nytimes.com/games/wordle")));
    }, b);
  }

  function k(e, t) {
    var n, a = (t = void 0 === t ? {} : t).insertAt;
    e && "undefined" != typeof document && (n = document.head || document.getElementsByTagName("head")[0], (t = document.createElement("style")).type = "text/css", "top" === a && n.firstChild ? n.insertBefore(t, n.firstChild) : n.appendChild(t), t.styleSheet ? t.styleSheet.cssText = e : t.appendChild(document.createTextNode(e)));
  }
  ...
  function C(e) {
    ...
    return _.createElement(s.TransitionGroup, null, _.createElement(s.CSSTransition, {
      key: r,
      timeout: { enter: a.animateIn ? N : 0, exit: a.animateOut ? N : 0 },
      classNames: o
    }, _.createElement("div", { className: x.moment }, _.createElement(a.component, { hasLoaded: t, transition: e }))));
  }
  ...
  function B(a) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : M(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  function W(e, t, n, a) {
    return { type: X, payload: { name: e, label: t, useBeacon: n, context: a } };
  }
  ...
  var D = "wordle/overlays/OPEN_MODAL", q = "wordle/overlays/CLOSE_MODAL", G = "wordle/overlays/OPEN_PAGE",
    F = "wordle/overlays/CLOSE_PAGE", V = "wordle/overlays/WILL_CLOSE_PAGE", Y = "wordle/overlays/OPEN_ERROR",
    U = "wordle/overlays/OPEN_NAV_MODAL", Z = "wordle/overlays/CLOSE_NAV_MODAL",
    X = "wordle/overlays/TRACK_NAV_MODAL_ITEM", K = "wordle/overlays/ADD_TOAST", J = "wordle/overlays/REMOVE_TOAST",
    Q = "wordle/overlays/TRACK_AUTH_CLICK", $ = "wordle/overlays/TRACK_AUTH_IMPRESSION", ee = function(e) {
      return {
        type: D,
        payload: { modal: e, isClicked: 1 < arguments.length && void 0 !== arguments[1] && arguments[1] }
      };
    }, te = function(e) {
    ...
    }, le = (null === (pe = window.env) || void 0 === pe ? void 0 : pe.name) || "dev", ce = function(e) {
      return e[le] || e.dev;
    }, ue = ce({
    ...
    }), me = "".concat(ue, "/svc/auth/v1/profileinfo"), A = ce({
  ...
  var Se = "abcdefghijklmnopqrstuvwxyz", ce = function(e) {
    return e.api;
    ...
    return e && !!t && !n;
  }), Ie = (n.createSelector(ce, function(e) {
  ...
  }), We = (n.createSelector([ce, A, Pe], function(e, t, n) {
    return e || t || n;
  }), 6), He = 5, De = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"], ue = function(e) {
    ...
    return e.map(function(e, t) {
      return n <= t ? null : function(e, t) {
        for (var n = Array(t.length).fill("absent"), a = Array(t.length).fill(!0), o = Array(t.length).fill(!0), r = 0; r < e.length; r += 1) e[r] === t[r] && o[r] && (n[r] = "correct", a[r] = !1, o[r] = !1);
        for (var s = 0; s < e.length; s += 1) {
          var i = e[s];
          if (a[s]) for (var l = 0; l < t.length; l += 1) {
            var c = t[l];
            if (o[l] && i === c) {
              n[s] = "present", o[l] = !1;
              break;
  ...
  tt.prototype.clear = function() {
    ...
    var t = this.__data__;
    return !((e = $e(t, e)) < 0) && (e == t.length - 1 ? t.pop() : et.call(t, e, 1), --this.size, !0);
  ...
  ce = "object" == ("undefined" == typeof global ? "undefined" : nt(global)) && global && global.Object === Object && global;
  ...
  var A = "object" == ("undefined" == typeof self ? "undefined" : at(self)) && self && self.Object === Object && self,
    ot = ce || A || Function("return this")(), ue = ot.Symbol, A = Object.prototype, rt = A.hasOwnProperty,
    st = A.toString, it = ue ? ue.toStringTag : void 0;
  var lt = Object.prototype.toString;
  var ct = "[object Null]", ut = "[object Undefined]", dt = ue ? ue.toStringTag : void 0;

  function mt(e) {
    return null == e ? void 0 === e ? ut : ct : dt && dt in Object(e) ? function(e) {
  ...
  var gt = "[object AsyncFunction]", ft = "[object Function]", ht = "[object GeneratorFunction]", bt = "[object Proxy]";
  ...
  var A = ot["__core-js_shared__"],
    kt = (ue = /[^.]+$/.exec(A && A.keys && A.keys.IE_PROTO || "")) ? "Symbol(src)_1." + ue : "";
  var _t = Function.prototype.toString;
  var vt = /^\[object .+?Constructor\]$/, A = Function.prototype, ue = Object.prototype, A = A.toString,
    ue = ue.hasOwnProperty,
    xt = RegExp("^" + A.call(ue).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");

  function St(e) {
    var t;
    return yt(e) && (t = e, !(kt && kt in t)) && (wt(e) ? xt : vt).test(function(e) {
      if (null != e) {
        try {
          return _t.call(e);
        } catch (e) {
  ...
  var jt = Et(ot, "Map"), zt = Et(Object, "create");
  ...
  function It(e, t) {
    var n, a = e.__data__;
    return ("string" == (e = Ot(n = t)) || "number" == e || "symbol" == e || "boolean" == e ? "__proto__" !== n : null === n) ? a["string" == typeof t ? "string" : "hash"] : a.map;
  }
  ...
  At.prototype.clear = function() {
    ...
    this.size = 0, this.__data__ = { hash: new At, map: new (jt || tt), string: new At };
  ...
  Tt.prototype.clear = function() {
    ...
    if (n instanceof tt) {
      var a = n.__data__;
      if (!jt || a.length < 199) return a.push([e, t]), this.size = ++n.size, this;
  ...
  var A = "object" == ("undefined" == typeof exports ? "undefined" : Ht(exports)) && exports && !exports.nodeType && exports,
    ue = A && "object" == ("undefined" == typeof module ? "undefined" : Ht(module)) && module && !module.nodeType && module,
    ue = ue && ue.exports === A ? ot.Buffer : void 0, Dt = ue ? ue.allocUnsafe : void 0;
  var qt = ot.Uint8Array;

  function Gt(e, t) {
    var n, n = t ? (t = e.buffer, n = new t.constructor(t.byteLength), new qt(n).set(new qt(t)), n) : e.buffer;
    return new e.constructor(n, e.byteOffset, e.length);
  }

  var Ft = Object.create, Vt = function(e) {
    if (!yt(e)) return {};
    if (Ft) return Ft(e);
    Yt.prototype = e;
    e = new Yt;
  ...
  var Ut, Zt, Xt = (Ut = Object.getPrototypeOf, Zt = Object, function(e) {
    return Ut(Zt(e));
  }), Kt = Object.prototype;
  ...
  var A = Object.prototype, tn = A.hasOwnProperty, nn = A.propertyIsEnumerable, an = en(function() {
    return arguments;
  }()) ? en : function(e) {
    return $t(e) && tn.call(e, "callee") && !nn.call(e, "callee");
  }, on = Array.isArray, rn = 9007199254740991;
  ...
  var ue = "object" == ("undefined" == typeof exports ? "undefined" : cn(exports)) && exports && !exports.nodeType && exports,
    A = ue && "object" == ("undefined" == typeof module ? "undefined" : cn(module)) && module && !module.nodeType && module,
    A = A && A.exports === ue ? ot.Buffer : void 0, un = (A ? A.isBuffer : void 0) || function() {
      return !1;
    }, dn = "[object Object]", ue = Function.prototype, A = Object.prototype, mn = ue.toString, pn = A.hasOwnProperty,
    yn = mn.call(Object);
  var gn = {};
  ...
  var hn,
    ue = "object" == ("undefined" == typeof exports ? "undefined" : fn(exports)) && exports && !exports.nodeType && exports,
    bn = ue && "object" == ("undefined" == typeof module ? "undefined" : fn(module)) && module && !module.nodeType && module,
    wn = bn && bn.exports === ue && ce.process, A = function() {
      try {
        var e = bn && bn.require && bn.require("util").types;
        return e ? e : wn && wn.binding && wn.binding("util");
      } catch (e) {
      }
    }(), ue = A && A.isTypedArray, kn = ue ? (hn = ue, function(e) {
      return hn(e);
    }) : function(e) {
  ...
  function xn(e, t, n, a) {
    ...
    for (var r, s, i = -1, l = t.length; ++i < l;) {
      var c = t[i], u = a ? a(n[c], e[c], c, n, e) : void 0;
      void 0 === u && (u = e[c]), o ? Mt(n, c, u) : (r = u, s = void 0, s = (u = n)[c = c], vn.call(u, c) && Qe(s, r) && (void 0 !== r || c in u) || Mt(u, c, r));
    }
    return n;
  }
  ...
  function zn(e, t) {
    var n = Sn(e);
    return (t = null == t ? En : t) && ("number" == n || "symbol" != n && jn.test(e)) && -1 < e && e % 1 == 0 && e < t;
  }

  var Nn = Object.prototype.hasOwnProperty;

  function Cn(e, t) {
    var n, a = on(e), o = !a && an(e), r = !a && !o && un(e), s = !a && !o && !r && kn(e), i = a || o || r || s,
      l = i ? function(e, t) {
        for (var n = -1, a = Array(e); ++n < e;) a[n] = t(n);
        return a;
      }(e.length, String) : [], c = l.length;
    for (n in e) !t && !Nn.call(e, n) || i && ("length" == n || r && ("offset" == n || "parent" == n) || s && ("buffer" == n || "byteLength" == n || "byteOffset" == n) || zn(n, c)) || l.push(n);
    return l;
  }
  ...
  function Ln(e, t, n, a, o, r, s) {
    var i, l, c, u = _n(e, n), d = _n(t, n), m = s.get(d);
    m ? Bt(e, n, m) : ((i = void 0 === (l = r ? r(u, d, n + "", e, t, s) : void 0)) && (m = !(c = on(d)) && un(d), t = !c && !m && kn(d), l = d, c || m || t ? l = on(u) ? u : $t(c = u) && ln(c) ? function(e, t) {
      var n = -1, a = e.length;
      for (t = t || Array(a); ++n < a;) t[n] = e[n];
      return t;
    }(u) : m ? (c = d, (m = !(i = !1)) ? c.slice() : (m = c.length, m = Dt ? Dt(m) : new c.constructor(m), c.copy(m), m)) : t ? Gt(d, !(i = !1)) : [] : function(e) {
      if ($t(e) && mt(e) == dn) {
        e = Xt(e);
        if (null === e) return 1;
        e = pn.call(e, "constructor") && e.constructor;
        return "function" == typeof e && e instanceof e && mn.call(e) == yn;
      }
    }(d) || an(d) ? an(l = u) ? l = xn(u, In(u)) : yt(u) && !wt(u) || (l = "function" != typeof (u = d).constructor || Jt(u) ? {} : Vt(Xt(u))) : i = !1), i && (s.set(d, l), o(l, d, a, r, s), s.delete(d)), Bt(e, n, l));
  }

  function Tn(a, o, r, s, i) {
    a !== o && Wt(o, function(e, t) {
      var n;
      i = i || new Tt, yt(e) ? Ln(a, o, t, r, Tn, s, i) : (n = s ? s(_n(a, t), e, t + "", a, o, i) : void 0, Bt(a, t, n = void 0 === n ? e : n));
    }, In);
  }
  ...
  function Bn(r, s, i) {
    return s = Mn(void 0 === s ? r.length - 1 : s, 0), function() {
      for (var e = arguments, t = -1, n = Mn(e.length - s, 0), a = Array(n); ++t < n;) a[t] = e[s + t];
      for (var t = -1, o = Array(s + 1); ++t < s;) o[t] = e[t];
      return o[s] = i(a), function(e, t, n) {
        switch (n.length) {
          case 0:
            return e.call(t);
          case 1:
  ...
  var Rn = Date.now;
  var Wn, Hn, Dn, qn = (Wn = Pt ? function(e, t) {
  ...
  var Fn, Vn, Yn, Un = (Fn = function(e, t, n) {
    Tn(e, t, n);
  }, qn(Bn(Vn = function(e, t) {
    var n = -1, a = t.length, o = 1 < a ? t[a - 1] : void 0, r = 2 < a ? t[2] : void 0,
      o = 3 < Fn.length && "function" == typeof o ? (a--, o) : void 0;
    for (r && function(e, t, n) {
      if (yt(n)) {
        var a = Gn(t);
        return ("number" == a ? ln(n) && zn(t, n.length) : "string" == a && t in n) && Qe(n[t], e);
      }
    }(t[0], t[1], r) && (o = a < 3 ? void 0 : o, a = 1), e = Object(e); ++n < a;) {
      var s = t[n];
      s && Fn(e, s, n, o);
    }
    return e;
  }, Yn, Pn), Vn + "")), Zn = "nyt-wordle-state", Xn = {
    boardState: null,
    evaluations: null,
    rowIndex: null,
    solution: null,
  ...
  function Kn(e) {
    var t, t = (t = window.localStorage.getItem(Zn) || JSON.stringify(Xn), JSON.parse(t));
    !function(e) {
      try {
  ...
  function $n() {
    var e = Jn(Zn, Xn), t = function() {
        try {
          var e = window.localStorage.getItem(Ke) || JSON.stringify(Je);
          return JSON.parse(e);
        } catch (e) {
          return console.error("error retrieving stats", e), JSON.parse(JSON.stringify(Je));
        }
      }(), n = !!window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches, a = Jn(aa, n),
      o = Jn(oa, !1);
    return {
      game: {
      ...
      settings: { hardMode: (null == e ? void 0 : e.hardMode) || !1, darkMode: a || !1, colorblindMode: o || !1 },
      stats: t
    };
  }
  ...
  function ta(e) {
    var t = "nyt-wordle-moogle/".concat(e), n = ea("nyt-wordle-moogle/ANON", "[NONE]"),
  ...
  var aa = "nyt-wordle-darkmode", oa = "nyt-wordle-cbmode", ra = function(e, t) {
      t = e && t ? t : "ANON";
    ...
    }, la = "wordle/moogle/SET_INITIAL_STATE", ca = function() {
      return function(e, t) {
        var n = t(), t = Oe(n), n = Ae(n);
        t && (t = Qn(!0) || $n(), n = ra(!0, n), sa(n, t));
      };
    }, ua = function() {
      return function(e, t) {
        var n = t(), a = Ne(n), o = Ae(n), t = Ce(n) || 0, n = Ee(n), n = Qn(n, o),
      ...
      if (o) return {};
      var i, l, n = t.slice(0, a ? n - 1 : n);
      return i = n, l = {}, e.forEach(function(e, t) {
        var n = i[t];
        if (n) for (var a = 0; a < e.length; a += 1) {
          var o = e[a], r = n[a], s = l[o] || "unknown";
          we[s] < we[r] && (l[o] = r);
        }
      }), l;
    }), fa = "wordle/game/START_GAME", ha = "wordle/game/CONTINUE_GAME", ba = "wordle/game/ADD_LETTER",
    wa = "wordle/game/BACKSPACE", ka = "wordle/game/EVALUATE_ROW", _a = function(e) {
      e.today;
      return function(e, t) {
        var n, a = Fe(t()), o = Ye(t()), r = Re(t());
        if (!("prod" !== (null === (n = window.env) || void 0 === n ? void 0 : n.name) && document.location.search.includes("reset")) && o && o === r) return e({
          type: ha,
          payload: { currentRowIndex: a }
        });
      ...
      return function(e, t) {
        var n = t(), a = ya(n), o = Ve(n), r = Be(n), s = qe(n), i = Xe(n), l = Fe(n), t = O(n), n = Ze(n);
        if (!a) {
          if (o.length !== He) return e(se({ text: "Not enough letters", invalidate: !0 }));
          if ((a = o) !== r && !be.includes(a) && !he.includes(a)) return e(se({
          ...
          if (t) {
            var c = function(e, t, n) {
              ...
              for (var a, o, r, s = 0; s < n.length; s += 1) if ("correct" === n[s] && e[s] !== t[s]) return {
                validGuess: !1,
                errorMessage: "".concat((r = o = void 0, (a = s + 1) + ((o = ["th", "st", "nd", "rd"])[((r = a % 100) - 20) % 10] || o[r] || o[0])), " letter must be ").concat(t[s].toUpperCase())
              };
              for (var i = {}, l = 0; l < n.length; l += 1) ["correct", "present"].includes(n[l]) && (i[t[l]] ? i[t[l]] += 1 : i[t[l]] = 1);
              for (var c = e.split("").reduce(function(e, t) {
                return e[t] ? e[t] += 1 : e[t] = 1, e;
              }, {}), u = Object.keys(i), d = 0; d < u.length; d += 1) {
                var m = u[d];
                if ((c[m] || 0) < i[m]) return {
                  validGuess: !1,
                  errorMessage: "Guess must contain ".concat(m.toUpperCase())
                };
              }
              return { validGuess: !0 };
            }(o, s[l - 1], i[l - 1]), u = c.validGuess, c = c.errorMessage;
            if (!u) return e(se({ text: c || "Not valid in hard mode", invalidate: !0 }));
          }
          u = l + 1, c = o === r, l = !c && We <= u, r = c && !!n && 1 === _e(new Date(n), new Date), n = "IN_PROGRESS";
          c ? n = "WIN" : l && (n = "FAIL"), "IN_PROGRESS" !== n && function() {
            try {
              h.setItem(f, !0);
            } catch (e) {
              console.error(e);
            }
          }(), e({ type: ka, payload: { now: Date.now(), status: n, isStreak: r, numGuesses: u, guess: o } });
        }
      };
    }, Ea = ["timestamp"];
  ...
  function ja(e, t) {
    ...
    var n, a = function(e, t) {
      ...
      for (a = 0; a < r.length; a++) n = r[a], 0 <= t.indexOf(n) || (o[n] = e[n]);
      return o;
    }(e, t);
    if (Object.getOwnPropertySymbols) for (var o = Object.getOwnPropertySymbols(e), r = 0; r < o.length; r++) n = o[r], 0 <= t.indexOf(n) || Object.prototype.propertyIsEnumerable.call(e, n) && (a[n] = e[n]);
    return a;
  }

  function za(t) {
    return function(e) {
      e(ne()), e(ae()), e(re()), "malformed Moogle response data" === t.message && v.captureSentryError(t, {
        api: "moogle",
        category: "game_state"
      }), t.message && "No internet" === t.message ? e(R("offline")) : t.message && "profile" === t.message ? e(R("profile")) : e(R("default"));
    };
  }
  ...
  var Ca = "prod" === v.env.name ? "https://www.nytimes.com" : "https://www.stg.nytimes.com",
    Aa = "wordle/api/MOOGLE_OPT_IN", Oa = "wordle/api/LOAD_MOOGLE_GET", Ia = "wordle/api/MOOGLE_GET_SUCCESS",
    La = "wordle/api/MOOGLE_GET_ERROR", Ta = "wordle/api/LOAD_MOOGLE_POST", Pa = "wordle/api/MOOGLE_POST_SUCCESS",
    Ma = "wordle/api/MOOGLE_POST_ERROR", Ba = "wordle/api/MOOGLE_POST_RESET", Ra = "wordle/api/LOAD_SOLUTION",
    Wa = "wordle/api/SOLUTION_SUCCESS", Ha = "wordle/api/SOLUTION_ERROR", Da = "wordle/api/LOAD_PROFILE_INFO",
    qa = "wordle/api/PROFILE_INFO_SUCCESS", Ga = "wordle/api/PROFILE_INFO_ERROR", Fa = "wordle/api/START_SYNC",
    Va = "wordle/api/APP_LOADED", Ya = function(e) {
      var s = e.enableServerSolution, i = e.today;
      return function(t) {
        t({ type: Ra });
        var n = ve(i), a = xe(n), o = function() {
        ...
        function r(e) {
          t({ type: Wa, payload: { data: { solution: e.solution, dayOffset: e.days_since_launch, id: e.id } } });
        }

        return (s ? function() {
          return v.xhr.get((e = i, "".concat(v.env.edge, "/svc/wordle/v1/").concat(e.toLocaleDateString("en-CA"), ".json"))).catch(function(e) {
          ...
          s ? o().then(function(e) {
            r(e);
          }) : (t({ type: Ha }), e.message && "No internet" === e.message ? t(R("offline")) : t(R("default")));
        });
      };
    }, Ua = "user not authenticated for GET /state", Za = function(e) {
      var n = e.fetchFromMoogle, e = e.optIn, a = void 0 !== e && e;
      return function(t) {
        return n && ((e = document.cookie.toLowerCase()).includes("nyt-s") || e.includes("sidny")) ? (t({ type: Oa }), v.xhr.get("".concat(Ca, "/svc/games/state/wordle/latest"), { withCookie: !1 }).then(function(e) {
          ...
          e.message !== Ua && t({ type: La, payload: { message: e.message } });
        })) : Promise.resolve();
        var e;
      };
    }, Xa = function(o, r) {
      return function(t, e) {
        var n = Ae(e()), a = o.timestamp, e = ja(o, Ea);
        return n ? (t({ type: Ta }), v.xhr.post("".concat(Ca, "/svc/games/state"), {
          game: "wordle",
          game_data: e,
          puzzle_id: "1",
          ...
          t({
            ...
            duration: 3e3,
            isSystem: !0
          })), "malformed Moogle response data" === e.message && v.captureSentryError(e, {
            api: "moogle",
            category: "game_state"
          });
        })) : Promise.resolve();
  ...
  function Ka(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Ja(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Qa(o) {
    return $a.reduce(function(e, t) {
      var n, a;
      return o ? (n = (a = eo[t]).testName, a = a.activeVariant, e[t] = o(n) === a) : e[t] = !1, e;
    }, {});
  }

  var $a = ["auth", "moogleGet", "serverSolution", "welcomeMoment"], eo = {
    auth: { testName: "GAMES_wordleAuth_0427", activeVariant: "1_EnableAuth" },
    moogleGet: { testName: "GAMES_wordleMoogle_0422", activeVariant: "1_EnableMoogle" },
    serverSolution: { testName: "GAMES_wordleSolutionBE_0510", activeVariant: "1_EnableServerSolution" },
    welcomeMoment: { testName: "GAMES_wordleWelcomeMoment_0621", activeVariant: "1_EnableWordleWelcomeMoment" }
  }, to = _.createContext(Qa()), ue = function(e) {
    var t = e.children, e = Na().getVariant, a = Qa(e), e = Ka(_.useState(a), 2), o = e[0], r = e[1];
    return _.useEffect(function() {
      var t, n;
      t = a, n = o, $a.some(function(e) {
        return t[e] !== n[e];
      }) && r(a);
    }, [a]), _.createElement(to.Provider, { value: o }, t);
  }, no = function(e) {
  ...
  function lo(e) {
    var t = e.closeMoment, n = e.trackLink, a = T();
    return _.createElement("div", { className: io.container }, _.createElement("div", { className: io.note }, _.createElement("div", { className: io.statsIcon }, _.createElement("img", {
      alt: "Wordle",
      style: { content: "var(--wordle-stats-mini)" }
    })), _.createElement("div", { className: io.noteInfo }, _.createElement("div", { className: io.noteHeader }, "NOTE"), _.createElement("div", { className: io.noteDescription }, "See your stats wherever you play."), _.createElement("div", { className: io.noteSummary }, "To see your stats in the app, go to where you normally play and link them to a free account."), _.createElement("button", {
  ...
  function uo(e) {
    var t = e.children, a = e.optIn, n = e.styles, o = void 0 === n ? "" : n, r = e.trackEvent, n = e.ariaLabel,
      e = void 0 === n ? "" : n, s = T(), i = window.isHybridWebView, n = a ? ye : ge;
  ...
  var po = n.createSelector(mo, function(e) {
    ...
    return e.guesses;
  }), bo = n.createSelector([Xe, Ye, Fe, O, Ge, I, L], function(e, t, n, a, o, r, s) {
    t = "Wordle ".concat(t);
    t += " ".concat("WIN" === o ? n : "X", "/").concat(We), a && (t += "*");
    var i = "";
  ...
  function ko(e) {
    return e = e.small, _.createElement("div", { className: p(wo({}, co.smallIconAndTitle, e)) }, _.createElement("div", { className: p(co.icon, wo({}, co.small, e)) }), _.createElement("div", { className: p(co.title, wo({}, co.small, e)) }, "Wordle"));
  }

  function _o(e) {
    return e = e.children, _.createElement("div", { className: co.subtitle }, e);
  }

  function vo(e) {
    var t = e.dayOffset;
    if (!t) return null;
    var n, e = (n = t, (e = new Date(ke.valueOf())).setDate(e.getDate() + n), e.toLocaleDateString("en-us", {
      year: "numeric",
      month: "long",
      day: "numeric"
    }));
    return _.createElement("div", { className: co.dateContainer }, _.createElement("div", { className: co.date }, e), _.createElement("div", { className: co.wordleNumber }, "No. ", t));
  }

  function xo(e) {
    return e = e.buttons, _.createElement("div", { className: co.buttonContainer }, e.filter(function(e) {
      return !e.hide;
    }).map(function(e) {
      var t = e.onClick, n = e.text, a = e.secondary, e = e.isLogin, a = _.createElement("button", {
        key: n,
        type: "button",
        onClick: t,
  ...
  var Eo = { spinner: "Spinner-module_spinner__9s8G2", spin: "Spinner-module_spin__b-mBL" };

  function jo(e) {
    var t = e.circleColor, e = e.barColor;
  ...
  function zo(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? No(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
    ...
    return function(e, t) {
      ...
      if (r === a - 1 && (e({ type: Ao }), ["WIN", "FAIL"].includes(o))) {
        ...
        "WIN" === o && (a = De[a - 1], e(se({
          ...
          duration: 2e3,
          win: !0
        }))), "FAIL" === o && e(se({ text: t.toUpperCase(), duration: 1 / 0 })), setTimeout(function() {
          e(ee("stats"));
        }, 2500);
      }
    };
  ...
  var Ao = "wordle/transient/LAST_TILE_REVEAL", Oo = "wordle/transient/REMOVE_INVALID", Io = function() {
    return { type: Oo };
  }, Lo = {
  ...
  function To(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Po(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Mo(e) {
    var t = e.rowIndex, n = e.last, a = e.letter, o = e.evaluation, r = T(), s = _.useRef(null),
      i = To(_.useState("idle"), 2), l = i[0], c = i[1], e = To(_.useState(!1), 2), i = e[0], u = e[1];
    _.useEffect(function() {
      c(a ? "pop" : "idle");
    }, [a]), _.useEffect(function() {
      o && c("flip-in");
    }, [o]);
    e = "empty";
    return i && o ? e = o : a && (e = "tbd"), _.createElement("div", {
      className: Lo.tile,
      ref: s,
      onAnimationEnd: function(e) {
        e.animationName === Lo.PopIn && "pop" === l && c("idle"), e.animationName === Lo.FlipIn && (c("flip-out"), u(!0)), e.animationName === Lo.FlipOut && (c("idle"), n && s.current && void 0 !== t && r(Co(t)));
      },
      "data-state": e,
  ...
  function Go() {
    ...
    return _.useEffect(function() {
      ...
      className: Do.boardContainer,
      ref: l
    }, _.createElement("div", { className: Do.board, ref: c }, Array(We).fill(!0).map(function(e, t) {
  ...
  function Fo(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Vo(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  var Yo = { width: "24", height: "24", viewBox: "0 0 24 24" },
    Uo = { width: "24", height: "24", viewBox: "4 4 24 24" }, Zo = { width: "28", height: "28", viewBox: "4 4 24 24" },
    Xo = function(e) {
      var t = Fo(g.useState(Uo), 2), n = t[0], a = t[1], o = "help" === e || "statistics" === e || "settings" === e;
      return g.useEffect(function() {
        function e() {
          var e = Uo;
        ...
        return o ? (e(), window.addEventListener("resize", e)) : a(Yo), function() {
  ...
  function Jo(e) {
    var t = e.icon, n = e.onClick, a = e.disabled, o = void 0 !== a && a, a = e.id, r = e.fillColor, e = Xo(t);
    return _.createElement("svg", {
      id: a,
      xmlns: "http://www.w3.org/2000/svg",
      height: e.height,
      ...
      fill: r || (o ? "var(--icon-disabled)" : "share" === t ? "var(--white)" : "var(--color-tone-1)"),
      d: Ko[t]
    }));
  }
  ...
  function $o(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? er(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  k(".Loading-module_container__lnPKB {\n  display: flex;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  max-height: calc(100% - var(--header-height) - 1px);\n  left: 0;\n  justify-content: center;\n  background-color: var(--color-background);\n  z-index: var(--error-z-index);\n}\n\n.Loading-module_loadingContainer__tPgFk {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n  width: 82px;\n  height: 100%;\n  transition: opacity 0.2s;\n  opacity: 1;\n}\n\n.Loading-module_hide__A9nsN {\n  opacity: 0;\n}");
  var tr = 300;

  function nr(e) {
    var t = e.waitFor, n = void 0 === t ? tr : t, a = e.setBackground, t = void 0 === a ? "dark" : a,
      e = $o(_.useState(!1), 2), a = e[0], o = e[1], e = P(I), t = "light" !== t && e, e = t ? "#121213" : "#FFF";
    return So(function() {
      return o(!0);
    }, n), a ? _.createElement("div", {
      className: Qo.container,
      style: e ? { backgroundColor: e } : {}
    }, _.createElement("div", { className: Qo.loadingContainer }, _.createElement(jo, {
  ...
  var rr = [{
    ...
    letters: [{
      letter: "w",
      evaluation: "correct"
    }, { letter: "e" }, { letter: "a" }, { letter: "r" }, { letter: "y" }]
  }, {
    helpWord: "pills",
    letters: [{ letter: "p" }, {
      letter: "i",
      evaluation: "present"
    }, { letter: "l" }, { letter: "l" }, { letter: "s" }]
  }, {
    helpWord: "vague",
    letters: [{ letter: "v" }, { letter: "a" }, { letter: "g" }, { letter: "u", evaluation: "absent" }, { letter: "e" }]
  }];

  function sr(e) {
    var t = e.isPage, n = e.enableAuth, a = e.isLoggedIn, e = n && !(void 0 !== a && a), o = "".concat(P(Ye));
    return _.createElement("section", {
      className: p((n = {}, a = ar.page, t = t, a in n ? Object.defineProperty(n, a, {
        value: t,
        enumerable: !0,
        configurable: !0,
        writable: !0
      }) : n[a] = t, n))
    }, _.createElement("div", { className: ar.instructions }, _.createElement("p", null, "Guess the ", _.createElement("strong", null, "WORDLE"), " in 6 tries."), _.createElement("p", null, "Each guess must be a valid 5-letter word. Hit the enter button to submit."), _.createElement("p", null, "After each guess, the color of the tiles will change to show how close your guess was to the word."), _.createElement("div", { className: ar.examples }, _.createElement("p", null, _.createElement("strong", null, "Examples")), _.createElement("div", {
      "aria-label": rr[0].helpWord,
      className: ar.example
    }, or(rr[0]), _.createElement("p", null, "The letter ", _.createElement("strong", null, "W"), " is in the word and in the correct spot.")), _.createElement("div", {
      "aria-label": rr[1].helpWord,
      className: ar.example
    }, or(rr[1]), _.createElement("p", null, "The letter ", _.createElement("strong", null, "I"), " is in the word but in the wrong spot.")), _.createElement("div", {
      "aria-label": rr[2].helpWord,
      className: ar.example
    }, or(rr[2]), _.createElement("p", null, "The letter ", _.createElement("strong", null, "U"), " is not in the word in any spot."))), _.createElement("p", null, _.createElement("strong", null, "A new WORDLE will be available each day!")), _.createElement("p", { className: ar.reminderSignUp }, "Never miss a Wordle.", " ", _.createElement("a", {
    ...
    }, "Sign up"), " ", "for our daily reminder email.")), e && _.createElement("div", { className: ar.statsLogin }, _.createElement("div", { className: ar.rule }), _.createElement("div", { className: ar.statsIcon }, _.createElement("img", {
      alt: "Green Bar Graph",
      style: { content: "var(--wordle-stats-mini)" }
    })), _.createElement("div", { className: ar.loginText }, "Looking to load your saved stats?", _.createElement("br", null), _.createElement(uo, {
      ariaLabel: "Link for logging in or creating a free account",
      trackEvent: { eventName: "help", sendContext: !0, element: { name: "wordle", label: "log-in-welcome" } },
      optIn: !1
    }, "Log in here")), _.createElement(uo, {
      trackEvent: {
        eventName: "log-in-welcome",
        sendContext: !0,
        element: { name: "wordle", label: "log-in-welcome" }
      }, styles: ar.loginArrow, optIn: !1
    }, _.createElement("svg", {
      width: "24",
      height: "24",
      viewBox: "0 0 24 24",
  ...
  var cr = "wordle/stats/TRACK_STATS_IMPRESSION", ur = "wordle/stats/SHARE_STATS", dr = {
  ...
  function yr(e) {
    var n = e.stats;
    return _.createElement("div", { className: dr.statistics }, pr.map(function(e) {
      var t = n[e];
      return _.createElement("div", {
        className: dr.statisticContainer,
        key: e
      }, _.createElement("div", { className: dr.statistic }, t), _.createElement("div", { className: dr.label }, mr[e]));
    }));
  }
  ...
  function gr(e) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? fr(e, t) : void 0;
      }
    }(e) || function() {
  ...
  function br(e) {
    var t = e.guesses, n = e.rowIndex, a = e.gameStatus, o = [], r = Math.max.apply(Math, gr(Object.values(t)));
    if (Object.values(t).every(function(e) {
      return 0 === e;
    })) return _.createElement(_.Fragment, null, _.createElement("h1", null, "Guess Distribution"), _.createElement("div", { className: dr.noData }, "No Data"));
    for (var s, i, l = 1; l < Object.keys(t).length; l += 1) {
      var c = l, u = t[l], d = {
        ...
        m = (c = m = i = s = void 0, s = (u = d).rowGuess, i = d.percentGuesses, m = d.numGuesses, c = d.addHighlight, u = d.index, _.createElement("div", {
          className: dr.graphContainer,
          key: u
        }, _.createElement("div", { className: dr.guess }, s), _.createElement("div", { className: dr.graph }, _.createElement("div", {
          style: { width: "".concat(i, "%") },
          className: p(dr.graphBar, (hr(i = {}, dr.alignRight, 0 < m), hr(i, dr.highlight, c), i))
        }, _.createElement("div", { className: dr.numGuesses }, m)))));
      o.push(m);
    }
    return _.createElement(_.Fragment, null, _.createElement("h1", null, "Guess Distribution"), _.createElement("div", { className: dr.guessDistribution }, o));
  }
  ...
  var _r = 1e3, vr = 60 * _r, xr = 60 * vr, Sr = 24 * xr, Er = function(e) {
    return e.toString().padStart(2, "0");
  };

  function jr() {
    var e = wr(g.useState(""), 2), t = e[0], a = e[1];
    return g.useEffect(function() {
      var e = new Date;
      e.setDate(e.getDate() + 1), e.setHours(0, 0, 0, 0);
      var t = e.getTime(), e = function() {
        return a(function(e) {
          var t = (new Date).getTime(), n = Math.floor(e - t);
          if (n <= 0) return "00:00:00";
          e = Math.floor(n % Sr / xr), t = Math.floor(n % xr / vr), n = Math.floor(n % vr / _r);
    ...
    }, []), _.createElement("div", { className: dr.statisticContainer }, _.createElement("div", { className: p(dr.statistic, dr.timer) }, _.createElement("div", {
      id: "timer",
      "data-testid": "timer"
    }, t)));
  }
  ...
  function Nr(e) {
    var t = e.trackClick;
    return _.createElement("div", { className: zr.promo }, _.createElement("div", { className: zr.rule }), _.createElement("a", {
      href: "https://www.nytimes.com/puzzles/spelling-bee",
      className: zr.promoLink,
      onClick: function(e) {
        e.stopPropagation(), t();
      }
    }, _.createElement("div", { className: zr.promoIcon }, _.createElement("svg", {
      width: "42",
      height: "44",
      viewBox: "0 0 42 44",
      fill: "none",
      ...
      stroke: "#121212",
      strokeWidth: "1.5"
    }))), _.createElement("div", { className: zr.promoText }, _.createElement("span", { className: zr.promoTextPrimary }, "How many words can you find", " "), _.createElement("span", { className: zr.promoTextsecondary }, "using 7 letters?"), _.createElement("span", { className: zr.promoCta }, "Play Spelling Bee")), _.createElement("div", { className: zr.promoArrow }, _.createElement("svg", {
      width: "24",
      height: "24",
      viewBox: "0 0 24 24",
      fill: "none",
  ...
  function Tr(e) {
    var t = new Lr, e = function(e, t, n) {
      for (var a in e.success = !0, t) {
        var o = t[a], r = n.clipboardData;
        r.setData(a, o), "text/plain" === a && r.getData(a) !== o && (e.success = !1);
      }
      n.preventDefault();
    }.bind(this, t, e);
  ...
  function Mr(e) {
    var t, n = document.getSelection();
    n && ((t = document.createRange()).selectNodeContents(e), n.removeAllRanges(), n.addRange(t));
  }
  ...
  function Rr(a) {
    return Cr(this, void 0, void 0, function() {
      ...
      return Ar(this, function(e) {
        if (n = "text/plain" in a, "undefined" != typeof ClipboardEvent || void 0 === Ir.clipboardData || void 0 === Ir.clipboardData.setData) return Tr(a) || -1 < navigator.userAgent.indexOf("Edge") || Pr(document.body, a) || function(e) {
          ...
          a.innerText = e, n.appendChild(a), document.body.appendChild(t), Mr(a);
        ...
        if (t = a["text/plain"], Ir.clipboardData.setData("Text", t)) return [2, !0];
  ...
  function Wr(n) {
    return Cr(this, void 0, void 0, function() {
      return Ar(this, function(e) {
        if (Or) return [2, Or(n)];
        if (!Rr(((t = {})["text/plain"] = n, t))) throw new Error("writeText() failed");
        var t;
        return [2];
      });
    });
  ...
  function Gr(e, t, n) {
    try {
      Hr() && !(-1 < navigator.userAgent.toLowerCase().indexOf("firefox")) && void 0 !== navigator.share && navigator.canShare && navigator.canShare(e) ? navigator.share(e).catch(function() {
      }) : Wr(e.text).then(t, n);
    } catch (e) {
  ...
  function Fr(e, t, n) {
    var a, o;
    (qr() || Dr()) && window.isHybridWebView ? (a = null == e ? void 0 : e.text, null !== (o = window.NativeBridge) && void 0 !== o && o.share(a, "", "")) : Gr(e, t, n);
  }

  var Vr = "AuthCTA-module_container__mFg-m", Yr = "AuthCTA-module_icon__fZT88", Ur = "AuthCTA-module_promoIcon__2-SRz",
    Zr = "AuthCTA-module_textContainer__kIjDX", Xr = "AuthCTA-module_bold__ThmkP", Kr = "AuthCTA-module_subText__2Qsw5",
    Jr = "AuthCTA-module_title__iBYtq", Qr = "AuthCTA-module_line1__ehobb",
    $r = "AuthCTA-module_buttonsContainer__y0b1J", es = "AuthCTA-module_moreLink__pAJHo",
    ts = "AuthCTA-module_loginButton__0FcEr", ns = "AuthCTA-module_footer__9-hGG",
    as = "AuthCTA-module_footerContainer__j9w3x", os = "AuthCTA-module_promoButton__i3iNK",
    rs = "AuthCTA-module_shareButton__SsNA6", ss = "AuthCTA-module_shareIcon__x5WtP",
    is = "AuthCTA-module_shareText__o7WL-";

  function ls(e) {
    var t = e.loggedIn, n = e.moogleOptedIn, a = T(), e = t && !n, o = "IN_PROGRESS" !== P(Ge);
    return n ? null : _.createElement(_.Fragment, null, _.createElement("div", { className: Vr }, _.createElement("div", null, _.createElement("img", {
      className: Yr,
      alt: "Statistics Graph Bar in Green with Check Mark",
      style: { content: "var(--stats-auth)" }
    })), _.createElement("div", { className: Zr }, _.createElement("p", { className: Jr }, "New"), _.createElement("p", { className: p(Xr, Qr) }, "Link your stats to ", t ? "this" : "a free", " New York Times account."), _.createElement("p", { className: Kr }, "Your stats ", !t && "and streak", " will save wherever you play."))), _.createElement("div", { className: $r }, !t && _.createElement("div", { className: ts }, _.createElement(uo, {
      ariaLabel: "Link for logging in or creating a free account",
      optIn: !0,
      trackEvent: { eventName: "log-in-congrats", sendContext: !0 }
    }, "Log in or create a free account")), e && _.createElement("button", {
      type: "button",
      className: ts,
    ...
    }, "Link stats to my account"), _.createElement("br", null), _.createElement("button", {
      className: es,
      type: "button",
      onClick: function() {
        a(te("linkInfo"));
  ...
  function cs(e) {
    var t = e.handleShare, n = e.handleTrack;
    return _.createElement("div", { className: ns }, _.createElement("p", null, "NEXT WORDLE"), _.createElement(jr, null), _.createElement("div", { className: as }, _.createElement("a", {
      type: "button",
      id: "promo-button",
      className: os,
      onClick: function() {
      ...
      href: "https://www.nytimes.com/puzzles/spelling-bee"
    }, _.createElement("span", null, "Play Spelling Bee"), _.createElement("span", { className: Ur })), _.createElement("button", {
      type: "button",
      id: "share-button",
      className: rs,
      onClick: t
    }, _.createElement("span", { className: is }, "Share"), _.createElement(Jo, { id: ss, icon: "share" }))));
  }

  function us() {
    var t = T(), n = "".concat(P(Ye)), e = P(mo), a = P(Ge), o = P(Fe), r = P(bo), s = "IN_PROGRESS" !== a, i = P(Ee),
      l = !!P(Ae), c = no("auth") || i;
    ...
    function u() {
      v.trackClick({ name: "wordle", label: "next-game", context: "spelling-bee", useBeacon: !0 });
    }

    function d(e) {
      e.preventDefault(), e.stopPropagation(), v.trackClick({
        name: "wordle",
        label: "share",
        context: n
      }), Fr(r, function() {
        t(lr()), t(se({ text: "Copied results to clipboard", duration: 2e3, isSystem: !0 }));
      }, function() {
    ...
    if (c) {
      ...
      }, _.createElement("h1", { className: dr.statisticsHeading }, "Statistics"), _.createElement(yr, { stats: e }), _.createElement(br, {
        guesses: e.guesses,
        rowIndex: o,
        gameStatus: a
      }), _.createElement("div", { className: c }, _.createElement("button", {
        type: "button",
        className: dr.statsInfoBtn,
        onClick: function() {
          return t(te("statsProblem"));
        }
      }, "My stats don't look right >")), _.createElement("div", { className: dr.ctaContainer }, _.createElement(ls, {
        loggedIn: l,
        moogleOptedIn: i
      }), s ? _.createElement(cs, {
        handleTrack: u,
        handleShare: d
      }) : _.createElement("div", { className: dr.promoButtonContainer }, _.createElement("a", {
        type: "button",
        id: "promo-button",
  ...
  var ps = "wordle/settings/CHANGE_SETTING", ys = "Switch-module_container__DiBse", gs = "Switch-module_switch__LLcMj",
    fs = "Switch-module_knob__oRTpP", hs = "Switch-module_checked__81fA3", bs = "Switch-module_disabled__6ofuZ";
  ...
  var _s = "Settings-module_setting__IdN-T", vs = "Settings-module_title__f-cFy", xs = "Settings-module_text__o3woy",
    Ss = "Settings-module_feedbackLink__eL28L", Es = "Settings-module_description__rTo9u",
    js = "Settings-module_footnote__UtMtH", zs = "Settings-module_enableAuth__TOxGg";
  k(".Settings-module_setting__IdN-T {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid var(--color-tone-4);\n  padding: 16px 0;\n}\n.Settings-module_setting__IdN-T a,\n.Settings-module_setting__IdN-T a:visited {\n  color: var(--color-tone-2);\n}\n\n.Settings-module_title__f-cFy {\n  font-size: 18px;\n}\n\n.Settings-module_text__o3woy {\n  padding-right: 8px;\n}\n\n.Settings-module_feedbackLink__eL28L {\n  text-decoration: underline;\n}\n\n.Settings-module_description__rTo9u {\n  font-size: 12px;\n  color: var(--color-tone-2);\n}\n\n.Settings-module_footnote__UtMtH {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  padding: 16px;\n  color: var(--color-tone-2);\n  font-size: 12px;\n  text-align: right;\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-end;\n}\n\n@media (min-width: 501px) {\n  .Settings-module_footnote__UtMtH.Settings-module_enableAuth__TOxGg {\n    position: initial;\n    padding-left: 0;\n    padding-right: 0;\n  }\n}\n@media only screen and (min-device-width: 320px) and (max-device-width: 480px) {\n  .Settings-module_setting__IdN-T {\n    padding: 16px;\n  }\n}");
  var Ns = function() {
    var e = T(), t = P(Ye), n = P(Ge), a = P(Fe), o = P(L), r = P(I), s = P(O), i = P(Ee), l = P(Ae), c = no("auth"),
      u = !s && "IN_PROGRESS" === n && 0 !== a, a = c || i, c = window.isHybridWebView ? void 0 : ds(l);
    return _.createElement(_.Fragment, null, _.createElement("div", null, _.createElement("section", null, _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "Hard Mode"), _.createElement("div", { className: Es }, "Any revealed hints must be used in subsequent guesses")), _.createElement("div", null, _.createElement(ks, {
      disabled: u,
      name: "hardMode",
      onClick: function() {
        e(u ? se({
      ...
      selected: s
    }))), _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "Dark Theme")), _.createElement("div", null, _.createElement(ks, {
      name: "darkMode",
      onClick: function() {
        return e(ms("darkMode", !r));
      },
      selected: r
    }))), _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "High Contrast Mode"), _.createElement("div", { className: Es }, "For improved color vision")), _.createElement("div", null, _.createElement(ks, {
      name: "colorblindMode",
      onClick: function() {
        return e(ms("colorblindMode", !o));
      },
      selected: o
    })))), _.createElement("section", null, _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "Feedback")), _.createElement("div", null, _.createElement("a", {
      className: Ss,
      href: c,
      title: "nytgames@nytimes.com",
      onClick: function(e) {
        var t, n, a, o;
        window.isHybridWebView && window.NativeBridge && (e.preventDefault(), n = ta(t = l), a = t || "[NONE]", o = (new Date).getTimezoneOffset(), e = Object.entries(window.abra.tests).map(function(e) {
          return e.join("=");
        }).join(","), n = ["Hybrid summary:", "Platform: ".concat(window.newsreaderAppPlatform ? "News App" : "XW App"), "Viewport Size: ".concat(document.documentElement.clientWidth, " x ").concat(document.documentElement.clientHeight), "Timezone: ".concat("UTC".concat(0 < o ? "" : "+").concat(o / -60)), "Logged In: ".concat(t ? "yes" : "no"), "Regi: ".concat(a), "Web Version: ".concat(window.env.version), "Flags: ".concat(e), "Anon Local Storage: ".concat(n.anon), "Local Storage Statistics: ".concat(n.stats), "Local Storage for regi ".concat(a, ": ").concat(n.regi), "Build: ".concat(null === (n = window.sentryConfig) || void 0 === n ? void 0 : n.release)].join("\n"), window.NativeBridge.gamesSendEmail({
          type: "feedback",
          debugInfo: n
        }));
      }
    }, "Email"))), _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "Community")), _.createElement("div", null, _.createElement("a", {
      href: "https://twitter.com/NYTGames",
      target: "blank",
      title: "@NYTGames"
    }, "Twitter"))), _.createElement("div", { className: _s }, _.createElement("div", { className: xs }, _.createElement("div", { className: vs }, "Questions?")), _.createElement("div", null, _.createElement("a", {
      href: "https://help.nytimes.com/hc/en-us/articles/360029050872-Word-Games-and-Logic-Puzzles#h_01FVGCB2Z00ZQMDMCYWBPWJNXB",
      target: "blank"
    }, "FAQ"))))), _.createElement("div", {
      className: p(js, (i = a, (c = zs) in (a = {}) ? Object.defineProperty(a, c, {
        value: i,
        enumerable: !0,
        configurable: !0,
        writable: !0
      }) : a[c] = i, a))
    }, _.createElement("div", { id: "copyright" }, "© ", (new Date).getFullYear(), " The New York Times Company"), _.createElement("div", null, _.createElement("div", null, "#", t))));
  }, A = function(e) {
    return e.overlays;
  ...
  function Rs(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Ws(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Hs() {
    var t = T(), e = P(Cs), n = Rs(g.useState(!1), 2), a = n[0], o = n[1], r = P(Ee), s = no("auth") || r, i = !!P(Ae),
      l = s && "stats" === e && r;
    if (!e) return null;
    ...
    }[e], i = { help: "how to play", stats: !1, settings: "settings" }[e], e = s && i;
    return _.createElement("div", {
      ...
      role: "button"
    }, _.createElement("div", { className: p(Ps.content, (Bs(n = {}, Ps.closing, a), Bs(n, Ps.enableAuth, s), Bs(n, Ps.shortStatsModal, l), n)) }, e ? _.createElement("h1", { className: p(Ps.heading, Bs({}, Ps.enableAuth, s)) }, i) : null, r, _.createElement("div", { className: Ps.closeIcon }, _.createElement(Jo, Ms({ icon: "close" }, s && { onClick: c })))));
  }

  function Ds() {
    var e = T();
    return _.createElement("a", {
      href: "https://www.nytimes.com/crosswords", onClick: function() {
  ...
  k(".Nav-module_container__pzbhW {\n  display: flex;\n  flex-direction: column;\n  align-items: left;\n  justify-content: center;\n}\n.Nav-module_container__pzbhW a.Nav-module_navLink__7jXMp {\n  text-decoration: none;\n  color: inherit;\n}\n\n.Nav-module_gameList__izZcv,\n.Nav-module_nytList__Nrzcc {\n  list-style: none;\n  color: var(--color-tone-1);\n  padding: unset;\n  margin: unset;\n}\n\n.Nav-module_nytList__Nrzcc {\n  margin-top: 5px;\n  padding: 12px 0px;\n  border-top: 1px solid #dcdcdc;\n}\n\n.Nav-module_navItem__Kfeh3 {\n  display: flex;\n  justify-content: left;\n  align-items: center;\n  height: 40px;\n  font-family: \"nyt-franklin-500\";\n  font-size: 16px;\n  line-height: 16px;\n  padding-left: 18px;\n  --hover-color: var(--color-nav-hover);\n}\n\n.Nav-module_navItem__Kfeh3:hover {\n  background-color: var(--hover-color);\n}\n\n.Nav-module_navIcon__mgXpj {\n  padding-bottom: 2px;\n  content: \"\";\n  height: 20px;\n  width: 28px;\n  padding-right: 8px;\n  display: inline-block;\n  vertical-align: middle;\n  background-repeat: no-repeat;\n  background-size: \"20px\";\n}\n\n.Nav-module_navHeader__KJ4Rd {\n  padding-top: 18px;\n  padding-left: 18px;\n}\n\n.Nav-module_moreText__-hcDZ {\n  font-family: \"nyt-franklin\";\n  font-weight: 700;\n  text-transform: uppercase;\n  font-size: 12px;\n  line-height: 12px;\n  margin: 32px 0px 24px 0px;\n  padding-left: 18px;\n}\n\n.Nav-module_privacy__H6Jto, .Nav-module_privacyStatic__f2hFM {\n  letter-spacing: 0.5px;\n  font-family: \"nyt-franklin-500\";\n  margin: 0px 25px 0px 17px;\n  padding: 12px 0px;\n  border-top: 1px solid #dcdcdc;\n  color: var(--color-tone-1);\n  text-align: left;\n  display: flex;\n  flex-direction: column;\n  align-items: left;\n  justify-content: center;\n  font-size: 12px;\n}\n\n.Nav-module_privacyItem__F1mag {\n  height: 40px;\n  display: flex;\n  justify-content: left;\n  align-items: center;\n  color: var(--color-tone-1);\n}\n\n.Nav-module_privacyStatic__f2hFM {\n  position: static;\n}");
  var Gs = "NavAccount-module_navLoggedIn__QNQGf", Fs = "NavAccount-module_navLoggedOut__yVhCA",
    Vs = "NavAccount-module_navDrawerHeading__KRAqm", Ys = "NavAccount-module_navDrawerAccount__WqYWH",
    Us = "NavAccount-module_navProfileAccount__sqIxG", Zs = "NavAccount-module_logoutButton__rHSrz",
    Xs = "NavAccount-module_subscribeButton__9oHNa", Ks = "NavAccount-module_loginButton__ANAQ0",
    Js = "NavAccount-module_navDrawerLink__YqJIR";

  function Qs(e) {
    var t = e.loggedIn,
      n = _.createElement("a", { href: de, role: "button", tabIndex: -1, className: Xs }, "Subscribe"),
      a = _.createElement("a", { href: ge, role: "button", tabIndex: -1, className: Ks }, "Log In"),
      e = _.createElement("a", { href: fe, role: "button", tabIndex: -1, className: Zs }, "Log Out");
    return _.createElement("div", { className: Ys }, t ? _.createElement("div", { className: Us }, _.createElement("h4", { className: Vs }, "Profile"), _.createElement("a", {
      href: window.navigationLinks.account,
      className: Js
    }, "Account details"), _.createElement("div", { className: Gs }, e)) : _.createElement("div", { className: Fs }, n, a));
  }
  ...
  function $s() {
    ...
    function t() {
      return {
        backgroundImage: 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "",
        backgroundSize: "20px"
      };
    }

    var e = v.parsePurrCookieValue(), n = no("auth"), a = P(Ee), n = n || a, a = !!n && !!P(Ae), o = T();
    return _.createElement("div", { className: qs.container }, _.createElement("span", { className: qs.navHeader }, _.createElement(Ds, null)), _.createElement("span", { className: qs.moreText }, "More From New York Times Games"), _.createElement("div", { className: qs.gameList }, [{
      id: "spelling-bee",
      name: "Spelling Bee",
      ...
      }, _.createElement("div", { className: qs.navItem }, _.createElement("span", {
        style: t(e.backgroundImage),
        className: qs.navIcon
      }), e.name));
    })), _.createElement("div", { className: qs.nytList }, [{
      id: "nyt",
      ...
      return _.createElement("a", {
        "aria-label": e.name, href: e.url, className: qs.navLink, onClick: function() {
          return o(W("wordle", e.dataTrackLabel, !0, null));
        }, id: e.id, key: e.id, "data-track-label": e.dataTrackLabel
      }, _.createElement("div", { className: qs.navItem }, _.createElement("span", {
        style: t(e.backgroundImage),
        className: qs.navIcon
      }), e.name));
    })), _.createElement("div", { className: n ? qs.privacyStatic : qs.privacy }, _.createElement("a", {
  ...
  function ti(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? ni(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  var oi = {
    ...
    statsProblem: {
      ...
      text: ["Wordle currently saves your stats to the device or browser you play on. <b>If this is not where you regularly play, go to that device or browser and check if your stats are correct. You can save to an account from there.</b>", "If this is the device or browser where you regularly play and your stats are not updating, visit <a target=\"_blank\" href=\"https://help.nytimes.com/hc/en-us/articles/360029050872-Word-Games-and-Logic-Puzzles#h_01FVGCB2Z00ZQMDMCYWBPWJNXB\">our FAQ</a> for more troubleshooting tips.", "If your stats are completely missing, your progress may have been reset if your browser data was cleared. We recommend logging in or creating a free account to save your stats from anywhere."],
  ...
  function si(e) {
    var t = e.type, n = e.loggedIn, a = void 0 !== n && n, o = e.optedIn, r = void 0 !== o && o, s = e.onClose,
      i = e.trackClick, l = T(), c = a && !r, u = "linkInfo" === t ? "more-info" : "broken-stats", d = oi[t],
      m = d.text, n = d.title, o = d.icon, e = d.alt, d = d.text2, d = void 0 === d ? "" : d, r = !!d && !r,
      t = "linkInfo" === t ? ri.containerLink : ri.containerProblems;
    return _.createElement(_.Fragment, null, _.createElement("div", { className: ri.headerNew }, _.createElement("p", null, _.createElement("img", {
      ...
      "data-testid": "close",
      onClick: s
    }, _.createElement(Jo, { icon: "close" }))), _.createElement("div", { className: t }, _.createElement("img", {
      alt: e,
      style: { content: o }
    }), _.createElement("h1", { className: ri.title }, n), _.createElement("div", null, m.map(function(e) {
      return _.createElement("p", { key: e, className: ri.text, dangerouslySetInnerHTML: { __html: e } });
    })), _.createElement("div", { className: ri.statsLinkContainer }, !a && _.createElement(uo, {
      optIn: !0,
      ariaLabel: "Link for logging in or creating a free account",
      styles: ri.loginButton,
      trackEvent: { eventName: "log-in-".concat(u), sendContext: !1 }
    }, "Log in or create a free account"), c && _.createElement("button", {
      type: "button",
      tabIndex: -1,
    ...
    }, "Link stats to my account"))), r && _.createElement("p", {
      className: ri.explainerFooterText,
      dangerouslySetInnerHTML: { __html: d }
    }));
  }

  k(".Explainer-module_title__-DKFu {\n  font-family: \"nyt-franklin\";\n  font-size: 24px;\n  font-weight: 700;\n  line-height: 28px;\n  letter-spacing: 0em;\n  text-align: left;\n  margin-left: 10px;\n  color: var(--color-tone-1);\n}\n\n.Explainer-module_containerLink__CFd3e {\n  padding: 30px;\n}\n.Explainer-module_containerLink__CFd3e p:last-child {\n  font-weight: 700;\n}\n\n.Explainer-module_containerProblems__8fCRH {\n  padding: 30px;\n}\n\n.Explainer-module_containerLink__CFd3e,\n.Explainer-module_containerProblems__8fCRH {\n  padding-top: 14px;\n}\n\n.Explainer-module_explainerFooterText__ZeeBX {\n  margin: 30px;\n  padding-top: 30px;\n  border-top: 1px solid var(--gray-2);\n  font-size: 15px;\n  line-height: 130%;\n}\n\n.Explainer-module_text__keVaW {\n  font-size: 14px;\n  line-height: 130%;\n  letter-spacing: 0.01em;\n  text-align: left;\n  margin-left: 10px;\n  color: var(--color-tone-1);\n}\n.Explainer-module_text__keVaW > a {\n  color: inherit;\n}\n\n.Explainer-module_statsLinkContainer__1PALX {\n  margin-top: 40px;\n}\n\n.Explainer-module_loginButton__XupvV {\n  height: 44px;\n  background: var(--color-tone-1);\n  border-radius: 104px;\n  text-decoration: none;\n  color: var(--color-tone-7);\n  font-weight: 700;\n  line-height: 14px;\n  font-size: 14px;\n  text-align: center;\n  padding: 0 30px;\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  letter-spacing: 0.05em;\n}\n\n.Explainer-module_gamesIcon__spKfI {\n  width: 95px;\n  height: 18px;\n}\n\n.Explainer-module_headerNew__SaqiR {\n  padding: 15px 0px;\n}\n.Explainer-module_headerNew__SaqiR > p {\n  text-align: center;\n  margin: 10px 0px;\n}\n\n.Explainer-module_close__F3zLu {\n  background: none;\n  color: inherit;\n  border: none;\n  padding: 0;\n  font: inherit;\n  cursor: pointer;\n  outline: inherit;\n  position: absolute;\n  right: 0;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  cursor: pointer;\n  margin: 0;\n  margin-right: 30px;\n}");
  var ii = "StatsLink-module_container__G4oYM", li = "StatsLink-module_header__8CPRA",
    ci = "StatsLink-module_logo__Kx2s-", ui = "StatsLink-module_content__7z9K3",
    di = "StatsLink-module_statsIconWrapper__lzf6R", mi = "StatsLink-module_statsFailureBadge__qQmvE",
    pi = "StatsLink-module_statsIcon__-nU--", yi = "StatsLink-module_headingWrapper__DV4V8",
    gi = "StatsLink-module_heading__8G3Jk", fi = "StatsLink-module_paragraphWrapper__5sxeO",
    hi = "StatsLink-module_paragraph__Q-baL", bi = "StatsLink-module_email__xzzCz",
    wi = "StatsLink-module_button__F7k0J", ki = "StatsLink-module_footer__Qxrmi", _i = "StatsLink-module_link__YBHY7",
  ...
  function xi(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Si(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  var Ei = { line1: "Your stats will be linked to this", line2: "New York Times account" }, ji = {
    ...
    n = i ? ji : Ei;
    return a ? _.createElement("div", { className: ii }, _.createElement("header", { className: li }, _.createElement("img", {
      alt: "New York Times logo",
      className: ci,
      style: { content: "var(--nyt-logo)" }
    })), _.createElement("div", null, _.createElement(nr, {
      waitFor: 150,
      setBackground: "light"
    }))) : _.createElement("div", { className: ii }, _.createElement("header", { className: li }, _.createElement("img", {
      alt: "New York Times logo",
      className: ci,
      style: { content: "var(--nyt-logo)" }
    })), _.createElement("div", { className: ui }, _.createElement("div", { className: di }, i && _.createElement("svg", {
      className: mi,
      width: "44",
      height: "44",
      viewBox: "0 0 44 44",
    ...
    })), _.createElement("div", { className: yi }, _.createElement("h1", { className: gi }, n.line1), _.createElement("h1", { className: gi }, n.line2)), _.createElement("div", { className: fi }, i && _.createElement("p", { className: hi }, "You are logged in as"), _.createElement("p", { className: p(hi, bi) }, e && e.email)), _.createElement("button", {
      className: wi,
      onClick: function() {
        i ? t() : (r({ type: Aa }), r({
          type: Fa,
          payload: { enableAuth: !0 }
        })), r(ie("", !1, { label: i ? "stats-link-error" : "stats-link-confirm", name: "wordle" }));
      },
      type: "button"
    }, i ? "Go back to stats" : "Confirm and save"), _.createElement("footer", { className: ki }, !i && _.createElement(_.Fragment, null, _.createElement("p", { className: p(hi, vi) }, "Not the right account?"), _.createElement(uo, {
      optIn: !0,
      styles: _i,
      ariaLabel: "Link for logging in or creating a free account"
  ...
  function Ai(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Oi(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Ii() {
    var t = T(), e = P(Os), n = Ai(g.useState(!1), 2), a = n[0], o = n[1], r = !!P(Ae), s = P(Ee), i = no("auth") || s,
      l = P(Ts);
    ...
    n = function(e) {
      ...
      help: { content: _.createElement(sr, { isPage: !0 }), title: "How to play" },
      linkInfo: {
        content: _.createElement(si, {
          onClose: function() {
            return o(!0);
          }, type: "linkInfo", loggedIn: r, optedIn: s, trackClick: function(e) {
            return t(ie(e, !1));
          }
        }), title: ""
      },
      statsProblem: {
        content: _.createElement(si, {
          onClose: function() {
            return o(!0);
          }, loggedIn: r, optedIn: s, type: "statsProblem", trackClick: function(e) {
            return t(ie(e, !1));
          }
        }), title: ""
      },
    ...
    }[e], s = r.content, r = r.title;
    if (i) {
      i = ["statsLink"].includes(e);
      return _.createElement("div", {
        "data-testid": "pageNew",
        className: p(Ni.pageNew, (Ci(e = {}, Ni.closing, a), Ci(e, Ni.noDarkMode, i), e)),
        onAnimationEnd: n
    ...
    return _.createElement("div", {
      ...
      onAnimationEnd: n
    }, _.createElement("div", { className: Ni.content }, _.createElement("header", null, _.createElement("h1", null, r), _.createElement("button", {
      type: "button",
      className: Ni.close,
      "data-testid": "close",
      onClick: function() {
  ...
  k(".ToastContainer-module_toaster__QDad3 {\n  position: absolute;\n  top: 45px;\n  left: 50%;\n  transform: translate(-50%, 0);\n  pointer-events: none;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n}\n\n#ToastContainer-module_gameToaster__yjzPn {\n  z-index: var(--toast-z-index);\n}\n\n#ToastContainer-module_systemToaster__fIZdf {\n  z-index: var(--system-toast-z-index);\n}");
  var Ti = { toast: "Toast-module_toast__Woeb-", win: "Toast-module_win__7-aZX", fade: "Toast-module_fade__uPhAg" };
  ...
  function Bi(e) {
    var t = e.toast, n = t.text, a = t.duration, o = t.timestamp, r = T(), e = Pi(g.useState(!1), 2), t = e[0],
      s = e[1];
    return So(function() {
      return s(!0);
    }, a === 1 / 0 ? null : a), _.createElement("div", {
      className: p(Ti.toast, (e = {}, a = Ti.fade, t = t, a in e ? Object.defineProperty(e, a, {
        value: t,
        enumerable: !0,
        configurable: !0,
        writable: !0
      }) : e[a] = t, e)), onTransitionEnd: function() {
        r(H(n, o));
      }
    }, n);
  }
  ...
  function Ri() {
    var e = P(Ls), t = e.filter(function(e) {
      return e.isSystem;
    }), n = e.filter(function(e) {
      return !e.isSystem;
    }), e = function(e, t) {
      return _.createElement("div", { className: Li.toaster, id: t }, e.map(function(e) {
        return _.createElement(Bi, { key: "".concat(e.text, "-").concat(e.timestamp), toast: e });
      }));
    };
    return _.createElement(_.Fragment, null, e(n, Li.gameToaster), e(t, Li.systemToaster));
  }

  k(".Toast-module_toast__Woeb- {\n  position: relative;\n  margin: 16px;\n  background-color: var(--color-tone-8);\n  color: var(--color-tone-7);\n  padding: 13px;\n  border: none;\n  border-radius: 4px;\n  opacity: 1;\n  transition: opacity 300ms cubic-bezier(0.645, 0.045, 0.355, 1);\n  font-weight: 700;\n  font-size: 14px;\n  line-height: 16px;\n}\n\n.Toast-module_win__7-aZX {\n  background-color: var(--color-correct);\n  color: var(--tile-text-color);\n}\n\n.Toast-module_fade__uPhAg {\n  opacity: 0;\n}");
  var Wi = function() {
    var e;
  ...
  function Vi(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Yi(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Ui() {
    var e, t, n = Vi(g.useState(!1), 2), a = n[0], o = n[1];
    return _.createElement("div", {
      "aria-hidden": a,
      className: p(Hi.errorBannerContainer, (e = {}, t = Hi.hideBanner, n = a, t in e ? Object.defineProperty(e, t, {
        value: n,
        enumerable: !0,
        configurable: !0,
        writable: !0
      ...
      className: Hi.errorRow,
      "aria-hidden": a
    }, _.createElement("p", { className: Hi.errorTitle }, "Error"), _.createElement("span", {
      role: "button",
      className: Hi.close,
      onClick: function() {
        return o(!0);
      ...
      icon: "close",
      fillColor: "var(--white)"
    }))), _.createElement("p", null, "Oops, something went wrong. Please try again later."));
  }
  ...
  function Ki(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Ji(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  k(".Key-module_key__Rv-Vp {\n  font-family: inherit;\n  font-weight: bold;\n  border: 0;\n  padding: 0;\n  margin: 0 6px 0 0;\n  height: 58px;\n  border-radius: 4px;\n  cursor: pointer;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  background-color: var(--key-bg);\n  color: var(--key-text-color);\n  flex: 1;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  text-transform: uppercase;\n  -webkit-tap-highlight-color: rgba(0, 0, 0, 0.3);\n}\n.Key-module_key__Rv-Vp:focus {\n  outline: none;\n}\n.Key-module_key__Rv-Vp:last-of-type {\n  margin: 0;\n}\n.Key-module_key__Rv-Vp[data-state=correct] {\n  background-color: var(--key-bg-correct);\n  color: var(--key-evaluated-text-color);\n}\n.Key-module_key__Rv-Vp[data-state=present] {\n  background-color: var(--key-bg-present);\n  color: var(--key-evaluated-text-color);\n}\n.Key-module_key__Rv-Vp[data-state=absent] {\n  background-color: var(--key-bg-absent);\n  color: var(--key-evaluated-text-color);\n}\n.Key-module_key__Rv-Vp.Key-module_fade__37Hk8 {\n  transition: background-color 0.1s ease, color 0.1s ease;\n}\n\n.Key-module_half__ljsj8 {\n  flex: 0.5;\n}\n\n.Key-module_one__HBOou {\n  flex: 1;\n}\n\n.Key-module_oneAndAHalf__K6JBY {\n  flex: 1.5;\n  font-size: 12px;\n}");

  function Qi(e) {
    return "←" === e ? _.createElement(Jo, { icon: "backspace" }) : "↵" === e ? "enter" : "a" <= e && e <= "z" ? e : void 0;
  }

  function $i(e) {
    var t = e.value, n = e.evaluation, a = Ki(_.useState(!1), 2), o = a[0], r = a[1], e = Qi(t);
    return _.useEffect(function() {
      n && r(!0);
    }, [n]), e ? _.createElement("button", {
      type: "button",
      "data-key": t,
      "data-state": n,
      className: p(Zi.key, (Xi(a = {}, Zi.oneAndAHalf, "←" === t || "↵" === t), Xi(a, Zi.fade, o), a)),
      onTransitionEnd: function() {
        return r(!1);
      }
    }, e) : _.createElement("div", { "data-testid": "spacer", className: 1 === t.length ? Zi.half : Zi.one });
  }

  var el = { keyboard: "Keyboard-module_keyboard__1HSnn", row: "Keyboard-module_row__YWe5w" };
  k(".Keyboard-module_keyboard__1HSnn {\n  height: var(--keyboard-height);\n  margin: 0 8px;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n\n.Keyboard-module_row__YWe5w {\n  display: flex;\n  width: 100%;\n  margin: 0 auto 8px;\n  /* https://stackoverflow.com/questions/46167604/ios-html-disable-double-tap-to-zoom */\n  touch-action: manipulation;\n}");
  var tl = [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["-", "a", "s", "d", "f", "g", "h", "j", "k", "l", "-"], ["↵", "z", "x", "c", "v", "b", "n", "m", "←"]];

  function nl() {
    function a(e) {
      "←" === e || "Backspace" === e ? n(xa()) : "↵" === e || "Enter" === e ? n(Sa()) : Se.includes(e.toLowerCase()) && n(va(e.toLowerCase()));
    }

    var t = g.useRef(null), n = T(), o = P(ga);
    return g.useEffect(function() {
      function e(e) {
        var t, n;
        !0 !== e.repeat && (t = e.key, n = e.metaKey, e = e.ctrlKey, n || e || !Se.includes(t.toLowerCase()) && "Backspace" !== t && "Enter" !== t || a(t));
      }
      ...
      className: el.keyboard, ref: t, onClick: function(e) {
        e = e.target.closest("button");
        e && t.current && t.current.contains(e) && void 0 !== e.dataset.key && a(e.dataset.key);
      }
    }, tl.map(function(e, n) {
      return _.createElement("div", { className: el.row, key: n }, e.map(function(e, t) {
        return _.createElement($i, { key: "".concat(e, "-").concat(n, "-").concat(t), value: e, evaluation: o[e] });
      }));
    }));
  }
  ...
  function al(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? ol(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function rl(e) {
    var t = e.dismissIcon,
      n = (e = al(_.useState((null === (n = window.navigator) || void 0 === n ? void 0 : n.onLine) || !1), 2))[0],
      a = e[1];
    return _.useEffect(function() {
      function e() {
        return a(!0);
    ...
    }, []), e = p("pz-offline-ticker", { "is-offline": !n }), _.createElement("div", {
      className: e,
      "aria-hidden": n
    }, "You're offline! Progress may not be saved.", t && _.createElement("span", {
      role: "button",
  ...
  function ul(e) {
    var t = e.isLoading, n = P(Ye), a = T(), o = no("auth"), r = P(As), e = P(Ee), s = o || e,
      e = { context: n || void 0, elementName: "wordle", moduleLabel: "in-game" }, t = !!r || t;
    return _.createElement("header", { className: p(cl.appHeader, "wordle-app-header") }, _.createElement("div", { className: cl.menuLeft }, _.createElement(ro, null, _.createElement("button", {
      type: "button",
      id: cl.navButton,
      className: cl.icon,
    ...
    }, _.createElement(ll, null))), _.createElement(so, null, _.createElement(oo, {
      buttonStyle: cl.hybridBackButton,
      trackData: e
    }))), _.createElement("div", { className: cl.title }, "Wordle"), _.createElement("div", { className: cl.menuRight }, _.createElement("button", {
      type: "button",
      id: "help-button",
      className: cl.icon,
      "aria-label": "Help",
      tabIndex: -1,
      onClick: function() {
        v.trackClick({ name: "wordle", label: "help", context: n, useBeacon: !0 }), a((s ? ee : te)("help"));
      }
    }, _.createElement(Jo, { icon: "help" })), _.createElement("button", {
      type: "button",
      ...
      disabled: t
    }, _.createElement(Jo, { icon: "statistics", disabled: t })), _.createElement("button", {
      type: "button",
      id: "settings-button",
      className: cl.icon,
      "aria-label": "Settings",
      tabIndex: -1,
      onClick: function() {
        v.trackClick({ name: "wordle", label: "settings", context: n, useBeacon: !0 }), a((s ? ee : te)("settings"));
      },
      disabled: t
    }, _.createElement(Jo, { icon: "settings", disabled: t }))));
  }

  k(".AppHeader-module_appHeader__1Ehyv {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: flex-start;\n  flex-wrap: nowrap;\n  padding: 0px var(--header-padding-x);\n  height: var(--header-height);\n  color: var(--color-tone-1);\n  border-bottom: 1px solid var(--color-tone-4);\n}\n.AppHeader-module_appHeader__1Ehyv button.AppHeader-module_icon__x7b46 {\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 0 4px;\n}\n.AppHeader-module_appHeader__1Ehyv button.AppHeader-module_icon__x7b46:last-child {\n  padding-right: 0;\n}\n\n.AppHeader-module_appHeader__1Ehyv .AppHeader-module_title__6sqs- {\n  flex-grow: 2;\n  font-family: \"nyt-karnakcondensed\";\n  font-weight: 700;\n  font-size: 28px;\n  letter-spacing: 0.01em;\n  text-align: left;\n  left: 0;\n  right: 0;\n  pointer-events: none;\n  position: relative;\n}\n\n.AppHeader-module_menuLeft__iErDO {\n  display: flex;\n  margin: 0;\n  padding: 0;\n  align-items: center;\n  justify-content: flex-start;\n}\n\n.AppHeader-module_menuRight__jUeYn {\n  display: flex;\n  justify-content: flex-end;\n}\n\n#AppHeader-module_navButton__fB5nf {\n  padding-top: 2px;\n  padding-left: 0px;\n  padding-right: 13px;\n}\n\n@media (min-width: 1024px) {\n  .AppHeader-module_appHeader__1Ehyv .AppHeader-module_title__6sqs- {\n    text-align: center;\n    font-size: 36px;\n  }\n  .AppHeader-module_appHeader__1Ehyv button.AppHeader-module_icon__x7b46 {\n    padding: 0 6px;\n  }\n}\n@media (min-width: 768px) {\n  .AppHeader-module_appHeader__1Ehyv .AppHeader-module_title__6sqs- {\n    text-align: center;\n    font-size: 32px;\n  }\n  .AppHeader-module_appHeader__1Ehyv .AppHeader-module_menuLeft__iErDO,\n.AppHeader-module_appHeader__1Ehyv .AppHeader-module_menuRight__jUeYn {\n    width: 120px;\n  }\n}\n@media (min-width: 768px) and (min-width: 1024px) {\n  .AppHeader-module_appHeader__1Ehyv .AppHeader-module_title__6sqs- {\n    font-size: 36px;\n  }\n}\n@media (min-width: 768px) {\n  #AppHeader-module_navButton__fB5nf {\n    padding-top: 2px;\n    padding-left: 0px;\n  }\n}");

  function dl(e) {
    var t, n, a = e.hasLoaded, o = P(Ee), r = P(je), s = (no("auth") || o) && r;
    t = a, n = T(), e = P(Ue), r = P(As), So(function() {
      return n(ee("help"));
    }, !e && t && !r ? 100 : null);
    s = _.createElement("div", {
      className: sl,
      id: "wordle-app-game"
    }, o && _.createElement(rl, { dismissIcon: _.createElement(Jo, { icon: "close" }) }), s && _.createElement(Ui, null), _.createElement(Go, null), _.createElement(nl, null), _.createElement(ai, null), _.createElement(Hs, null), _.createElement(Ii, null), _.createElement(Ri, null), _.createElement(Fi, null));
    return _.createElement(_.Fragment, null, _.createElement(ul, { isLoading: !a }), a ? s : _.createElement(nr, null));
  }
  ...
  var ml = {
    welcome: {
      component: function(e) {
        ...
        var n, a, o, r, s = e.transition, i = T(), l = P(Fe), c = !!P(Ae), u = P(Ye), d = !!P(Ce), m = 0 < l,
          p = (a = m, n = c, y = P(Ge), o = P(fo), g = P(Fe), a && "IN_PROGRESS" === y ? "Youʼre on attempt ".concat(g + 1, " out of 6. Keep it up!") : "WIN" === y ? "Great job on todayʼs puzzle! Check out your progress." : "FAIL" === y ? "Tomorrow’s a new day, with a new puzzle. See you then." : n && !a && 0 < o ? _.createElement(_.Fragment, null, "Go ahead, add another day to your", " ", _.createElement("span", { className: co.bold }, o, " day"), " streak.") : _.createElement(_.Fragment, null, "Get 6 chances to guess a", " ", _.createElement("span", { className: co.noWrap }, "5-letter"), " word.")),
          e = (k = m, r = P(Ge), k ? "IN_PROGRESS" !== r ? "Hi Wordler" : "Welcome Back" : ""),
          y = (l = m, g = P(Ge), l ? "IN_PROGRESS" === g ? "Continue" : "See Stats" : "Play"),
          g = (n = m, a = c, o = P(fo), k = P(Ye), r = P(Ge), k = (g = l = "").concat(k), g = a ? (l = "".concat(o), "welcome-modal") : "softregiwall", {
            label: l,
            name: g = n ? "IN_PROGRESS" !== r ? "welcome-see-stats-modal" : "welcome-back-modal" : g,
            region: "wordle-welcome",
            context: k
          }), f = g.name, h = g.region, b = g.label, w = g.context,
          k = { context: u || void 0, elementName: "wordle", moduleLabel: "welcome" };
        _.useEffect(function() {
          v.trackImpression(f, h, b, w);
        }, []);
        var g = window.isHybridWebView && !d && !m;
        return _.createElement("div", { className: co.contentWelcome }, _.createElement(so, null, _.createElement("div", { className: co.back }, _.createElement(oo, { trackData: k }))), _.createElement("div", { className: co.contentWelcomeContainer }, _.createElement(ko, { small: m }), e && _.createElement("div", { className: co.title }, e), _.createElement(_o, null, p), _.createElement(xo, {
          buttons: [{
            hide: m || d,
            text: "How to play",
            secondary: !0,
            ...
            hide: m || c, text: "Log in", secondary: !0, isLogin: !0, onClick: function() {
              t("log-in-welcome");
            }
          }, {
            text: y, onClick: function() {
              s("game"), m && t("continue");
            }
          }]
        }), _.createElement(vo, { dayOffset: u })), g && _.createElement(lo, {
      ...
      component: function(e) {
        var t = e.hasLoaded, n = e.transition, a = zo(_.useState(!1), 2), e = a[0], o = a[1];
        return So(function() {
          return o(!0);
        }, t ? null : 300), _.useEffect(function() {
          t && n("welcome");
        }, [t]), _.createElement("div", { className: co.contentWelcome }, _.createElement(so, null, _.createElement("div", { className: co.back }, _.createElement(oo, {
          trackData: {
            elementName: "wordle",
            moduleLabel: "loading"
          }
        }))), _.createElement("div", { className: co.contentWelcomeContainer }, e && _.createElement(_.Fragment, null, _.createElement(ko, { small: !0 }), _.createElement("div", { className: co.spinner }, _.createElement(jo, null)))));
      }
    }, game: { component: dl }
  };

  function pl() {
    var n, a, o, t, r, e = !!P(Ae), s = P(Ee), i = P(Oe), l = P(ze), c = T(), u = Na(), d = u.hasAbraLoaded,
      m = u.getVariant, p = "1_EnableAuth" === m("GAMES_wordleAuth_0427") || s,
    ...
    }, []), n = P(Cs), a = P(Os), o = T(), g.useEffect(function() {
      if (window.isHybridWebView && window.NativeBridge) {
        var t = function(e) {
          n ? (o(ne()), e.respondWith({ gamesOnNavigateBack: !0 })) : a ? (o(ae()), e.respondWith({ gamesOnNavigateBack: !0 })) : e.respondWith({ gamesOnNavigateBack: !1 });
        };
        return window.NativeBridge.addEventListener("gamesOnNavigateBack", t), function() {
          var e;
          null !== (e = window.NativeBridge) && void 0 !== e && e.removeEventListener("gamesOnNavigateBack", t);
        };
      }
    }, [n, a, o]), _.useEffect(function() {
      var e, t, n, a;
      !l && d && (e = "true" === (t = new URLSearchParams(window.location.search)).get("moogle"), t = "true" === t.get("success"), c((t = (e = {
        optIn: !p && e || t || s,
        enableServerSolution: y
      }).optIn, n = void 0 !== t && t, e = e.enableServerSolution, a = void 0 !== e && e, function(e) {
        n && e({ type: Aa });
        var t = new Date;
        return Promise.all([e(Za({ fetchFromMoogle: !0, optIn: n })), e(Ya({
          enableServerSolution: a,
          today: t
        }))]).then(function() {
          e(ca());
        }).then(function() {
          e(ua()), e(_a({ today: t })), e({ type: Va, payload: { appLoaded: !0 } });
        });
      })));
    }, [l, d]), _.useEffect(function() {
      d && (p && e && !s) && c(se({
        text: "You are now logged in to your Times Account.",
        duration: 2e3,
        isSystem: !0
      }));
    }, [p, e, s, d]), _.useEffect(function() {
      d && (p && e && i) && (c(se({
        text: "Your stats have been linked to your account.",
        duration: 2e3,
        isSystem: !0
      })), c({ type: V }), c({ type: $, payload: { name: "stats-successful", region: "wordle-stats-link" } }));
    }, [p, i, e, d]), t = P(I), r = P(L), g.useEffect(function() {
      var e = document.querySelector("body");
      e && (t && !e.classList.contains("dark") ? e.classList.add("dark") : t || e.classList.remove("dark"));
    }, [t]), g.useEffect(function() {
      var e = document.querySelector("body");
      e && (r && !e.classList.contains("colorblind") ? e.classList.add("colorblind") : r || e.classList.remove("colorblind"));
    }, [r]), u ? _.createElement(C, {
      hasLoaded: l,
      config: ml,
      initialMoment: (m = document.referrer.includes("nytimes.com") && !document.referrer.includes("myaccount"), u = new URLSearchParams(document.location.search), window.isHybridWebView || m || u.get("forceWelcomeMoment") ? "loading" : "game")
  ...
  function gl(a) {
    for (var e = 1; e < arguments.length; e++) {
      var o = null != arguments[e] ? arguments[e] : {};
      e % 2 ? yl(Object(o), !0).forEach(function(e) {
        var t, n;
        t = a, e = o[n = e], n in t ? Object.defineProperty(t, n, {
          value: e,
          enumerable: !0,
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : yl(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  var kl, _l, vl = {
    hardMode: !1,
    darkMode: (null === (kl = document.body) || void 0 === kl || null === (_l = kl.className) || void 0 === _l ? void 0 : _l.includes("dark")) || !1,
    colorblindMode: !1
  };
  ...
  function xl(e, t) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Sl(e, t) : void 0;
      }
    }(e, t) || function() {
      throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function jl(a) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : El(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  function Nl(e) {
    return function(e) {
      ...
      if (e) {
        ...
        var n = Object.prototype.toString.call(e).slice(8, -1);
        return "Map" === (n = "Object" === n && e.constructor ? e.constructor.name : n) || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? Cl(e, t) : void 0;
      }
    }(e) || function() {
      throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    }();
  ...
  function Ol(a) {
    for (var e = 1; e < arguments.length; e++) {
      var o = null != arguments[e] ? arguments[e] : {};
      e % 2 ? Al(Object(o), !0).forEach(function(e) {
        var t, n;
        t = a, e = o[n = e], n in t ? Object.defineProperty(t, n, {
          value: e,
          enumerable: !0,
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : Al(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  var Il = { modal: null, page: null, error: null, isNavModalOpen: !1, toasts: [], isPageClosing: !1 };
  ...
  function Tl(a) {
    for (var e = 1; e < arguments.length; e++) {
      var o = null != arguments[e] ? arguments[e] : {};
      e % 2 ? Ll(Object(o), !0).forEach(function(e) {
        var t, n;
        t = a, e = o[n = e], n in t ? Object.defineProperty(t, n, {
          value: e,
          enumerable: !0,
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : Ll(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  var Pl = { isAnimatingRow: !1, lastRowInvalid: !1, lastRowWin: !1, isRestoringSession: !1 };
  ...
  function Bl(a) {
    for (var e = 1; e < arguments.length; e++) {
      var o = null != arguments[e] ? arguments[e] : {};
      e % 2 ? Ml(Object(o), !0).forEach(function(e) {
        var t, n;
        t = a, e = o[n = e], n in t ? Object.defineProperty(t, n, {
          value: e,
          enumerable: !0,
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : Ml(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  var Wl = {
    ...
    persist: a.combineReducers({
      game: function() {
        var n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : fl,
          a = 1 < arguments.length ? arguments[1] : void 0;
        switch (a.type) {
          case la:
            return null !== (o = a.payload) && void 0 !== o && o.game ? a.payload.game : n;
          case fa:
            var e = a.payload, t = e.numRows, o = e.id, e = e.dayOffset;
            return gl(gl({}, n), {}, {
              id: o,
              dayOffset: e,
          ...
          case ba:
            return gl(gl({}, n), {}, {
              boardState: n.boardState.map(function(e, t) {
                return t === n.currentRowIndex ? "".concat(e).concat(a.payload.letter) : e;
              })
            });
          case wa:
            return gl(gl({}, n), {}, {
              boardState: n.boardState.map(function(e, t) {
                return t === n.currentRowIndex ? e.slice(0, e.length - 1) : e;
              })
            });
          case ka:
            ...
            return gl(gl({}, n), {}, {
              ...
              timestamps: gl(gl({}, n.timestamps), {}, {
                lastCompleted: "IN_PROGRESS" === e ? n.timestamps.lastCompleted : t,
                lastPlayed: t
              }),
              status: e
            });
        ...
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : vl,
          t = 1 < arguments.length ? arguments[1] : void 0;
        switch (t.type) {
          case la:
            return null !== (a = t.payload) && void 0 !== a && a.settings ? t.payload.settings : e;
          case ps:
            var n = t.payload, a = n.name, n = n.value;
            return bl(bl({}, e), {}, wl({}, a, n));
          default:
            return e;
        }
      }, stats: function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : zl,
          t = 1 < arguments.length ? arguments[1] : void 0;
        switch (t.type) {
          case la:
            return null !== (r = t.payload) && void 0 !== r && r.stats ? t.payload.stats : e;
          case ka:
            var n = t.payload, a = n.status, o = n.isStreak, r = n.numGuesses;
            return "IN_PROGRESS" === a ? e : (n = e, o = (a = {
              isWin: "WIN" === a,
              isStreak: o,
              numGuesses: r
            }).isWin, r = a.isStreak, a = a.numGuesses, n = jl(jl({}, n), {}, { guesses: jl({}, n.guesses) }), o ? (n.guesses[a] += 1, r ? n.currentStreak += 1 : n.currentStreak = 1) : (n.currentStreak = 0, n.guesses.fail += 1), n.maxStreak = Math.max(n.currentStreak, n.maxStreak), n.gamesPlayed += 1, n.gamesWon += o ? 1 : 0, n.winPercentage = Math.round(n.gamesWon / n.gamesPlayed * 100), 0 === n.gamesWon ? n.averageGuesses = 0 : n.averageGuesses = Math.round(Object.entries(n.guesses).reduce(function(e, t) {
              var n = xl(t, 2), t = n[0], n = n[1], n = e + parseInt(t, 10) * n;
              return "fail" !== t ? n : e;
            }, 0) / n.gamesWon), n);
          default:
            return e;
      ...
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : Il,
        t = 1 < arguments.length ? arguments[1] : void 0;
      switch (t.type) {
        case D:
        ...
        case K:
          var n = t.payload,
            a = { text: n.text, duration: n.duration || 1e3, isSystem: n.isSystem, timestamp: n.timestamp },
            n = e.toasts;
          return Ol(Ol({}, e), {}, { toasts: [a].concat(Nl(n)) });
        case J:
          var n = t.payload, o = n.text, r = n.timestamp, n = e.toasts.filter(function(e) {
      ...
      switch (t.type) {
        ...
        case K:
          var n = t.payload, a = n.invalidate, n = n.win;
          return a ? Tl(Tl({}, e), {}, { lastRowInvalid: !0 }) : n ? Tl(Tl({}, e), {}, { lastRowWin: !0 }) : e;
        case Oo:
          return Tl(Tl({}, e), {}, { lastRowInvalid: !1 });
        case ha:
          return 0 === t.payload.currentRowIndex ? e : Tl(Tl({}, e), {}, {
            isAnimatingRow: !0,
        ...
        case Ao:
          return Tl(Tl({}, e), {}, { isAnimatingRow: !1, isRestoringSession: !1 });
        default:
          return e;
      }
    }, api: function() {
      var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : Wl,
        t = 1 < arguments.length ? arguments[1] : void 0;
      switch (t.type) {
        case Aa:
          return Bl(Bl({}, e), {}, { moogleGet: Bl(Bl({}, e.moogleGet), {}, { optedIn: !0 }) });
        case Oa:
          return Bl(Bl({}, e), {}, { moogleGet: Bl(Bl({}, e.moogleGet), {}, { isLoading: !0 }) });
        case Ra:
          return Bl(Bl({}, e), {}, { solution: Bl(Bl({}, e.solution), {}, { isLoading: !0 }) });
        case Ia:
          var n = t.payload, a = n.data, o = n.optIn;
          return Bl(Bl({}, e), {}, {
            moogleGet: Bl(Bl({}, e.moogleGet), {}, {
              data: a,
              isLoading: !1,
              error: !1,
              optedIn: o || !!a.version
        ...
        case Wa:
          n = t.payload.data, o = n.solution, a = n.id, n = n.dayOffset;
          return Bl(Bl({}, e), {}, {
            solution: Bl(Bl({}, e.solution), {}, {
        ...
        case Ha:
          return Bl(Bl({}, e), {}, { solution: Bl(Bl({}, e.solution), {}, { isLoading: !1, error: !0 }) });
        case Da:
          return Bl(Bl({}, e), {}, { profileInfo: { isLoading: !0, data: null, error: !1 } });
        case qa:
          return Bl(Bl({}, e), {}, { profileInfo: { isLoading: !1, data: t.payload.data, error: !1 } });
        case Ga:
          return Bl(Bl({}, e), {}, { profileInfo: { isLoading: !1, data: null, error: !0 } });
        case Ta:
          return Bl(Bl({}, e), {}, { mooglePost: Bl(Bl({}, e.mooglePost), {}, { isLoading: !0, error: !1 }) });
        case Pa:
          return Bl(Bl({}, e), {}, { mooglePost: { isLoading: !1, error: !1, lastFailedSaveData: null } });
        case Ma:
          return Bl(Bl({}, e), {}, {
            mooglePost: {
              isLoading: !1,
  ...
  var Vl = /^[-+]0x[0-9a-f]+$/i, Yl = /^0b[01]+$/i, Ul = /^0o[0-7]+$/i, Zl = parseInt;

  function Xl(e) {
    if ("number" == typeof e) return e;
    if ("symbol" == Fl(t = e) || $t(t) && "[object Symbol]" == mt(t)) return NaN;
    var t;
    if ("string" != typeof (e = yt(e) ? yt(n = "function" == typeof e.valueOf ? e.valueOf() : e) ? n + "" : n : e)) return 0 === e ? e : +e;
    e = Gl(e);
    var n = Yl.test(e);
    return n || Ul.test(e) ? Zl(e.slice(2), n ? 2 : 8) : Vl.test(e) ? NaN : +e;
  }

  var Kl = "Expected a function", Jl = Math.max, Ql = Math.min;

  function $l(a, n, e) {
    var o, r, s, i, l, c, u = 0, d = !1, m = !1, t = !0;
    ...
    function h() {
      ...
      if (o = arguments, r = this, c = e, t) {
        if (void 0 === l) return u = t = c, l = setTimeout(g, n), d ? p(t) : i;
        if (m) return clearTimeout(l), l = setTimeout(g, n), p(c);
      }
      return void 0 === l && (l = setTimeout(g, n)), i;
    }

    return n = Xl(n) || 0, yt(e) && (d = !!e.leading, m = "maxWait" in e, s = m ? Jl(Xl(e.maxWait) || 0, n) : s, t = "trailing" in e ? !!e.trailing : t), h.cancel = function() {
  ...
  function tc(a) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(o)) : ec(Object(o)).forEach(function(e) {
        Object.defineProperty(a, e, Object.getOwnPropertyDescriptor(o, e));
      });
    }
    return a;
  ...
  function nc(u) {
    ...
    return window.addEventListener("online", function() {
      ...
      return function(e) {
        var t, n = c(e), a = u.getState(), o = Ae(a), r = Ee(a), s = Oe(a), i = Math.floor(Date.now() / 1e3),
          l = tc(tc({}, a.persist), {}, { timestamp: i }), i = ra(r, o), o = [ps, ka, fa, Fa];
        return sc(l) || (o.includes(e.type) && (sa(i, l), r && (e.type === Fa ? (t = e.payload.enableAuth, u.dispatch(Xa(l, t))) : d(l))), s && e.type === ha && d(l), e.type === ps && (s = (t = a.persist.settings).hardMode, l = t.darkMode, t = t.colorblindMode, "hardMode" === e.payload.name && Kn({ hardMode: s }), "darkMode" === e.payload.name && sa(aa, l), "colorblindMode" === e.payload.name && sa(oa, t)), e.type === ka && (Kn(ia(a)), function(e) {
          try {
            window.localStorage.setItem(Ke, JSON.stringify(e));
          } catch (e) {
            console.error(e);
          }
        }(a.persist.stats)), e.type === fa && Kn(ia(a))), n;
      };
    };
  }
  ...
  function ac(_) {
    return function(k) {
      return function(e) {
        var t = k(e), n = _.getState(), a = L(n), o = I(n), r = "".concat(Ye(n)), s = O(n);
        switch (e.type) {
          case D:
            var i = e.payload, l = i.modal, i = i.isClicked;
          ...
          case U:
            ...
            break;
          case X:
            var u = e.payload, l = u.name, c = u.label, d = u.useBeacon, u = u.context;
            v.trackClick({ name: l, label: c, useBeacon: d, context: u });
            break;
          case ps:
            d = e.payload, u = d.name, d = d.value;
            v.trackModuleInteraction("click", r, "wordle", {
              darkMode: "dark-mode",
              colorblindMode: "high-contrast",
              hardMode: "hard-mode"
            }[u], d ? "turn-on" : "turn-off");
            break;
          case ka:
            var m = o ? "1" : "0", p = s ? "h" : "e", y = e.payload, g = y.numGuesses, f = y.status, y = y.guess;
            1 === g && v.trackModuleInteraction("click", r, "wordle", "start-game", "CB=".concat(a ? "1" : "0", " DM=").concat(m)), v.trackModuleInteraction("click", r, "wordle", "solve-attempt", "".concat(g.toString(), "-").concat(y)), "IN_PROGRESS" !== f && v.trackModuleInteraction("click", r, "wordle", "100%-complete", "".concat(p, "-").concat("WIN" === f ? g : 0));
            break;
          case cr:
            var m = e.payload.isGameComplete ? "congrats-modal" : "stats", y = po(n), p = go(n), f = fo(n), h = ho(n),
              g = yo(n);
            v.trackImpression("wordle", m, ["p: ".concat(y), "w: ".concat(g), "cs: ".concat(f), "ms: ".concat(p), "1: ".concat(h[1]), "2: ".concat(h[2]), "3: ".concat(h[3]), "4: ".concat(h[4]), "5: ".concat(h[5]), "6: ".concat(h[6])], r);
            break;
          case ur:
            v.trackModuleInteraction("click", r, "wordle", "share");
            break;
          case Q:
            var h = e.payload, b = h.label, w = h.sendContext, h = h.element, w = w ? r : null;
            v.trackClick(h ? { name: "", label: b, element: h, useBeacon: !0, context: w } : {
              name: "wordle",
              label: b,
              useBeacon: !0,
              context: w
  ...
  var oc, rc, sc = function(e) {
    var t = e.game.dayOffset, e = e.timestamp, e = ve(new Date(1e3 * e));
    return t && t < e;
  }, A = document.body;
  e.render(_.createElement(_.Fragment, null, _.createElement(r, null), _.createElement(t.Provider, { store: (oc = void 0 !== window.__REDUX_DEVTOOLS_EXTENSION__, rc = [a.applyMiddleware(o, nc, ac)], oc && rc.push(window.__REDUX_DEVTOOLS_EXTENSION__()), a.createStore(Hl, a.compose.apply(void 0, rc))) }, _.createElement(m, null, _.createElement(ue, null, _.createElement(pl, null))))), A);
});
