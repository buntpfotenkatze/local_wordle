  ...
  (r = [
    ...
    function (t, n, r) {
      ...
      e(
        ...
        o ||
          "function" != typeof i ||
          ((o = c("Promise").prototype.finally),
          i.prototype.finally !== o &&
            r(i.prototype, "finally", o, { unsafe: !0 }));
    },
    function (t, n, r) {
      var a = r(3),
        s = r(4).f,
    ...
    function (t, n, r) {
      ...
      t.exports = function (t, n) {
        ...
        if (((n = r.call(t, (n = n === O ? "default" : n))), !e(n) || o(n)))
          return n;
      ...
      t.exports = function (t) {
        return (
          (i(f, t) && (c || "string" == typeof f[t])) ||
            (c && i(a, t) ? (f[t] = a[t]) : (f[t] = s("Symbol." + t))),
          f[t]
        );
      };
    },
    ...
    function (t, n) {
      ...
      t.exports = function (t) {
        return (
          "Symbol(" + String(t === O ? "" : t) + ")_" + (++r + e).toString(36)
        );
      };
    },
    function (t, n, r) {
    ...
    function (t, n, r) {
      ...
      (l && y) ||
        ((l = function (t) {
          for (var n = [], r = arguments.length, e = 1; e < r; )
            n.push(arguments[e++]);
          return (
            (g[++b] = function () {
        ...
        p
          ...
          : i.addEventListener &&
            ...
            "file:" !== e.protocol &&
            !u(r)
          ? ((o = r), i.addEventListener("message", w, !1))
          : (o =
              d in a("script")
                ? function (t) {
